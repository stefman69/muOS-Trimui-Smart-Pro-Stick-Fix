...
8. If you see your stick jittering in the center of the stick visualizer after calibrating you can calibrate a dead zone using the D-pad by adding a percentage point and then spinning the stick a few times and seeing if it stays steady at centered, 7% seems to be good for both of my sticks
